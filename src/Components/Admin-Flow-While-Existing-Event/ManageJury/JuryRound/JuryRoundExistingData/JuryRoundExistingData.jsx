...
export const JuryRoundExistingData = ({ roundData }) => {
            ...
            <div className="newBtn">
              ...
              <div>
                <button onClick={() => setIsDropdownVisible(!isDropdownVisible)}>
                  {isDropdownVisible ? 'Hide Rounds' : 'Show Rounds'}
                </button>
                  ...
                  >
                    {roundData.length !== 0 ? (
                      roundData.map((round, index) => (
                        ...
                        >
                          <CreateButton onClick={() => handleNavigate(round.roundId)}>
                            {round.round_name} <MdEditSquare />
                          </CreateButton>
