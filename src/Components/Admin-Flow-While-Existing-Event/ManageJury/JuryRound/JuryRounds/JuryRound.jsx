...
import { JuryRoundExistingData } from "../JuryRoundExistingData/JuryRoundExistingData";
...
export const JuryRound = () => {
  ...
  console.log(initialEventId,"111111")
  ...
  useEffect(()=>{
    const fetchRounds = async () =>{
     try {
      ...
      console.log()
      const response = await axios.get(`${EXCHNAGE_URL}/listOfRounds?eventId=${eventId}`,{
        headers:{
  ...
  return (
   <>
    {  roundData.length !== 0 ? (<JuryRoundExistingData roundData={roundData} />):
      (
        <div>
