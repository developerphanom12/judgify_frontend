      ...
      <div className="submission_form_main">
        ...
        <form className="submission_form_div">
          ...
          <div className="submission_form_label">
            ...
            <div className="submission_form_label">
              <InputLabel>
              Name of Company Group  <span style={{ color: "#c32728" }}>*</span>
              </InputLabel>
          ...
          <div className="submission_form_label">
              <InputLabel>
              Company Head Office Address <span style={{ color: "#c32728" }}>*</span>
              </InputLabel>
          ...
          <div className="submission_form_label">
            ...
            <div className="submission_form_label">
              <InputLabel>
                 Alternate Contact Name <span style={{ color: "#c32728" }}>*</span>
              </InputLabel>
              <InputType placeholder="Enter Name"/>
            </div>
          </div>
